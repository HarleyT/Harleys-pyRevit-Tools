...
const jobBaseData = {
    ...
    "Ninja": {name: "Ninja", maxXp: 500, income: 100000},
...
const skillBaseData = {
    ...
    "Osmosis": {name: "Osmosis", maxXp: 100, effect: 1, description: "All xp"},
...
const jobCategories = {
    "Common work": ["Beggar", "Farmer", "Fisherman", "Miner", "Blacksmith", "Merchant", "Ninja"],
...
const skillCategories = {
    "Fundamentals": ["Concentration", "Productivity", "Bargaining", "Meditation", "Osmosis"],
...
function addMultipliers() {
    for (taskName in gameData.taskData) {
        ...
        if (task instanceof Job) {
            ...
            task.xpMultipliers.push(getBindedTaskEffect("Osmosis"))
...
gameData.requirements = {
    ...
    "Quick task display": new AgeRequirement([document.getElementById("quickTaskDisplay")]),
    ...
    "Ninja": new TaskRequirement([getTaskElement("Ninja")], []),
    ...
    "Osmosis": new TaskRequirement([getTaskElement("Osmosis")], []),
